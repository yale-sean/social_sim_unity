...
namespace UnityStandardAssets._2D
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        public float xSmooth = 0.25f; // How smoothly the camera catches up with it's target movement in the x axis.
        public float zSmooth = 0.25f; // How smoothly the camera catches up with it's target movement in the z axis.
        ...
        private void TrackPlayer()
        {
            ...
            if (CheckXMargin() || CheckZMargin()) {
                transform.position = Vector3.Lerp(transform.position, targetPos, ((xSmooth+zSmooth)/2)*Time.deltaTime);
            }
