...
{
    public class MSnoozeResponse : Message
    {
        public const string RosMessageName = "gizmo_msgs/Snooze";

        public string state;

        public MSnoozeResponse()
        {
            this.state = "";
        }

        public MSnoozeResponse(string state)
        {
            this.state = state;
        }
